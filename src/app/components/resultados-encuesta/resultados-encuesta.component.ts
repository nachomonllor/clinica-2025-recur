...
export class ResultadosEncuestaComponent implements OnInit {
  ...
  constructor(private statsService: EstadisticasService, private logService: LogIngresosService) {
  ...
  async cargarDatos() {
    ...
    try {
      ...
      this.logService.registrarIngreso('SURVEY_DATA_LOADED', 'ResultadosEncuestaComponent', 'cargarDatos', `Datos de encuestas cargados exitosamente para especialista ID: ${this.filtroEspecialista || 'Todos'}`); // Logueamos la carga exitosa de datos, mostrando el filtro aplicado (especialista específico o todos)
  ...
  async descargarPDF() {
    ...
    this.logService.registrarIngreso('PDF_DOWNLOADED', 'ResultadosEncuestaComponent', 'descargarPDF', `PDF de resultados de encuestas descargado para especialista ID: ${this.filtroEspecialista || 'Todos'}`); // Logueamos la descarga del PDF, mostrando el filtro aplicado (especialista específico o todos)
