...
// import { HistoriaClinicaDialogComponent } from './historia-clinica-dialog.component';
// import { Rol } from '../../../models/tipos.model';
// import { AccentColor, UsuarioAdmin, UsuarioAdminCard } from '../../../models/admin.model';
...
//   trackUsuario(index: number, usuario: UsuarioAdmin): string { return usuario.id; }
...
//   private async obtenerTurnosUsuario(usuario: UsuarioAdmin): Promise<TurnoSupabase[]> {
//     let query = this.supa.client
//       .from('turnos')
//       .select(`
//         id,
