...
//   templateUrl: './turnos-por-dia.component.html',
//   styleUrls: ['./turnos-por-dia.component.scss'],
//   // PROVIDER PARA FECHA DD/MM/YYYY
//   providers: [
//     { provide: MAT_DATE_LOCALE, useValue: 'es-AR' } 
//   ]
...
//   // --- CONFIGURACIÓN DEL GRÁFICO DE ÁREA (SPLINE) ---
//   chartOptions: Partial<ChartOptions> = {
//     chart: {
//       // TIPO ÁREA
//       type: 'area',
...
//     },
//     dataLabels: {
//       enabled: false // Generalmente se apagan en gráficos de área para que se vea más limpio
//     },
//     // LÍNEA SUAVE
//     stroke: { 
//       curve: 'smooth', 
...
//       categories: [],
//       title: { text: 'Fecha' },
//       // Menos etiquetas para que no se amontonen
//       tickAmount: 10, 
//       labels: { rotate: -20, trim: true }
//     },
...
//     //   min: 0,
//     //   forceNiceScale: true,
//     //   // AQUÍ ESTÁ LA CORRECCIÓN: Agregamos ": number"
//     //   labels: { formatter: (val: number) => val.toFixed(0) } 
//     // },
...
//       min: 0,
//       forceNiceScale: true,
//       // CORRECCIÓN AQUÍ: Agregamos el tipo explícito ': number'
//       labels: { formatter: (val: number) => val.toFixed(0) } 
//     },
//     // UN SOLO COLOR PRINCIPAL PARA LA LÍNEA
//     colors: ['#22D3EE'], 
//     // DEGRADADO DE RELLENO SUAVE
//     fill: {
//       type: 'gradient',
//       gradient: {
//         shadeIntensity: 1,
...
//     },
//     grid: { 
//       borderColor: 'rgba(255,255,255,.08)', // Más sutil
//       strokeDashArray: 4,
//       xaxis: { lines: { show: true } }, // Muestra líneas verticales también
//       yaxis: { lines: { show: true } }
//     },
//     tooltip: { 
//       theme: 'dark',
...
//     const [y, m, d] = dayKey.split('-').map(Number);
//     const dt = new Date(Date.UTC(y, m - 1, d));
//     // Formato corto para que no ocupe mucho espacio en el eje X
//     return dt.toLocaleDateString('es-AR', { day: '2-digit', month: '2-digit' });
//   }
...
//     // Aseguramos que el tipo sea 'area' al actualizar
//     const baseChart = this.chartOptions.chart ?? { type: 'area' as const, height: 420 };
...
//   // =========================================================
//   // Exportar a PDF (CON LOGO FANTASMA)
//   // =========================================================
//   async descargarPDF(): Promise<void> {
//     const el = document.getElementById('captura-pdf');
//     if (!el) return;

//     // USAMOS onclone PARA REVELAR EL LOGO
//     const canvas = await html2canvas(el, { 
//       scale: 2, 
//       backgroundColor: '#061126', // Fondo oscuro de tu app
//       logging: false,
//       useCORS: true,
//       onclone: (clonedDoc) => {
//         const logo = clonedDoc.querySelector('.logo-container') as HTMLElement;
//         if (logo) {
//           // Hacemos visible el logo solo para la captura
//           logo.style.display = 'flex';
//           logo.style.justifyContent = 'center';
//           logo.style.marginBottom = '20px';
//         }
...
//     // Usamos 'mm' y 'landscape' para mantener consistencia
//     const pdf = new jsPDF('landscape', 'mm', 'a4');
...
//   // =========================================================
//   // Exportar a IMAGEN (CON LOGO FANTASMA)
//   // =========================================================
//   async descargarImagen(): Promise<void> {
//     const el = document.getElementById('captura-pdf');
//     if (!el) return;

//     // USAMOS onclone TAMBIÉN AQUÍ
//     const canvas = await html2canvas(el, {
//       scale: 2,
//       backgroundColor: '#061126',
//       logging: false,
...
// //   // =========================================================
// //   // Exportar a PDF (CORREGIDO PARA FONDO OSCURO)
// //   // =========================================================
// //   async descargarPDF(): Promise<void> {
// //     const el = document.getElementById('captura-pdf');
// //     if (!el) return;

// //     // 1. FORZAMOS FONDO OSCURO PARA QUE EL GRÁFICO (TEXTO BLANCO) SE VEA BIEN
// //     const canvas = await html2canvas(el, { 
// //       scale: 2, 
// //       backgroundColor: '#0f172a', // <--- Mismo azul oscuro que el fondo de tu app
// //       logging: false 
// //     });
...
// //     // Título en negro (porque el fondo de la hoja es blanco)
// //     pdf.setFont('helvetica', 'bold');
// //     pdf.setFontSize(18);
// //     pdf.setTextColor(40); // Gris muy oscuro
// //     const solo = this.filtrosForm.value.soloFinalizados ? ' (solo finalizados)' : '';
// //     pdf.text(`Turnos por Día${solo}`, 40, 40);
